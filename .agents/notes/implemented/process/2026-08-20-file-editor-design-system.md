...
[`docs/design/DESIGN.md`](../../../../docs/design/DESIGN.md) is the file-editor brand board. It maps Harness `--dsw-alias-*` / `--ds-font-family-*` tokens onto generic primitives (including details segmented Tab and the file tab bar) and names editor overlay tokens in §4 (`editor-hover-tint`, `editor-selected-tint`, `editor-danger-hover-tint`, `editor-tab-active-line`, `editor-dirty-dot`). Runtime HEX and alias resolution stay in [`ui-theme`](../../../../packages/client/ui-theme/README.md) sheets; the living coding rules stay in [web-styling.md](../../../../docs/web-styling.md) and the [styling-system Agent Note](2026-07-19-web-styling-system.md). The Git panel, human terminal, embedded browser, and desktop-shell SPA content consume this same board without a second palette or §5 primitive; see the [Git panel design-system Agent Note](2026-08-25-git-panel-design-system.md), the [human-terminal design-system Agent Note](2026-08-29-human-terminal-design-system.md), the [embedded-browser design-system Agent Note](2026-08-30-embedded-browser-design-system.md), and the [desktop-shell design-system Agent Note](2026-08-31-desktop-shell-design-system.md).
