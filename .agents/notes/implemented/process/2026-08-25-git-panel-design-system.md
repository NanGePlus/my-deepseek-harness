...
[`docs/design/DESIGN.md`](../../../../docs/design/DESIGN.md) is the brand board for the Git panel as well as the file editor. The [file-editor design-system Agent Note](2026-08-20-file-editor-design-system.md) still owns overlay-token names, light-mode `--dsw-alias-brand-primary`, and the rule that UI implementation PRs do not edit global tokens.
