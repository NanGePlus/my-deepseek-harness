...
`packages/client/ui-git/tests/git-panel.client.spec.tsx` hovers a long `origin/` pill, asserts the card, then covers hide delay, card-enter, collapse, and an empty body/date on a local ref.
