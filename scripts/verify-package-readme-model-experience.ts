...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-file-editor': { kind: 'none', reason: 'Browser-side file-editor surface; listings and Git badges never enter the session log.' },
  'packages/client/ui-git': { kind: 'none', reason: 'Browser-side Git panel surface; working-tree lists and commit drafts never enter the session log.' },
  'packages/client/ui-terminal': { kind: 'none', reason: 'Browser-side human terminal surface; PTY I/O never enters the session log.' },
