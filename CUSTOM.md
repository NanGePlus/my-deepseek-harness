...
| `issue/94-host-browser-rpc` | [#94](https://github.com/NanGePlus/my-deepseek-harness/issues/94) Host browser RPC | 进行中 |
| `issue/95-app-shell-browser-tab` | [#95](https://github.com/NanGePlus/my-deepseek-harness/issues/95) app-shell：五段 Tab + 浏览器槽位 | 进行中 |
