...
export const zh = {
  ...
  'details.title': '详情',
  'details.tablist': '详情面板',
  'details.tab.tool': 'Tool 详情',
  'details.tab.editor': '文件编辑器',
  'details.close': '关闭详情',
  'details.toggle.open': '打开详情栏',
  'details.toggle.close': '收起详情栏',
...
export const en = {
  ...
  'details.tablist': 'Details panel',
  'details.tab.tool': 'Tool details',
  'details.tab.editor': 'File editor',
  'details.close': 'Close details',
  'details.toggle.open': 'Open details panel',
  'details.toggle.close': 'Collapse details panel',
