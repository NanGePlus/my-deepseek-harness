...
export const zh = {
  ...
  'details.title': '详情',
  'details.tablist': '工具箱',
  'details.tab.tool': '工具详情',
  'details.tab.editor': '资源管理器',
  'details.tab.git': 'Git面板',
  'details.tab.terminal': '终端',
  'details.tab.browser': '浏览器',
  'details.close': '关闭工具箱',
  'details.toggle.label': '工具箱',
  'details.toggle.open': '打开工具箱',
  'details.toggle.close': '收起工具箱',
...
export const en = {
  ...
  'details.tablist': 'Toolbox',
  'details.tab.tool': 'Tool details',
  'details.tab.editor': 'File editor',
  'details.tab.git': 'Git Panel',
  'details.tab.terminal': 'Terminal',
  'details.tab.browser': 'Browser',
  'details.close': 'Close toolbox',
  'details.toggle.label': 'Toolbox',
  'details.toggle.open': 'Open toolbox',
  'details.toggle.close': 'Collapse toolbox',
