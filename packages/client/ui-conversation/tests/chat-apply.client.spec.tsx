...
describe('apply wiring', () => {
  ...
  it('declares the details Git, terminal, and browser occupants alongside editor and tool seats', async () => {
    const b = await bench()
    ...
    expect(b.slots.spec('conversation.details.browser')).toEqual({ kind: 'single', scope: 'root' })
