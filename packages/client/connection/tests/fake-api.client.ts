...
export class FakeApiClient implements IApiClient {
  ...
  readonly host: IApiClient['host'] = {
    ...
    gitWorkingTree: payload => this.record('host.gitWorkingTree', payload, Promise.resolve(ok({ availability: 'not-a-repository' as const }))),
    gitInit: payload => this.record('host.gitInit', payload, Promise.resolve(ok({ repoRoot: '' }))),
    gitDiffPreview: payload => this.record('host.gitDiffPreview', payload, Promise.resolve(ok({ kind: 'binary' as const }))),
    gitStage: payload => this.record('host.gitStage', payload, Promise.resolve(ok({ availability: 'not-a-repository' as const }))),
    gitUnstage: payload => this.record('host.gitUnstage', payload, Promise.resolve(ok({ availability: 'not-a-repository' as const }))),
