...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('workspace-path-out-of-bounds'), message: z.string(), details: z.object({ workspaceId: z.string(), path: z.string() }) }),
  ...
  z.object({ code: z.literal('file-not-regular'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({
    code: z.literal('file-too-large'),
    message: z.string(),
    details: z.object({ path: z.string(), size: z.number(), limit: z.number() }),
  }),
  ...
  z.object({ code: z.literal('path-not-found'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('path-delete-failed'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('path-rename-failed'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('path-move-failed'), message: z.string(), details: z.object({ path: z.string() }) }),
  ...
  z.object({ code: z.literal('terminal-unavailable'), message: z.string(), details: z.object({ workspaceId: z.string().optional() }) }),
  z.object({ code: z.literal('terminal-session-not-found'), message: z.string(), details: z.object({ workspaceId: z.string(), sessionId: z.string() }) }),
  z.object({
    code: z.literal('browser-unavailable'),
    message: z.string(),
    details: z.object({
      workspaceId: z.string().optional(),
      reason: z.union([z.literal('chromium-missing'), z.literal('context-start-failed')]),
    }),
  }),
  z.object({ code: z.literal('browser-tab-not-found'), message: z.string(), details: z.object({ workspaceId: z.string(), tabId: z.string() }) }),
