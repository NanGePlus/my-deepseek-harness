...
export interface RpcMethodMap {
  ...
  'host.gitWorkingTree': HostApi['gitWorkingTree']
  'host.gitInit': HostApi['gitInit']
  'host.gitDiffPreview': HostApi['gitDiffPreview']
  ...
  'host.gitAddRemote': HostApi['gitAddRemote']
  'host.gitRemoveRemote': HostApi['gitRemoveRemote']
  'host.gitLog': HostApi['gitLog']
  'host.gitCommitDiff': HostApi['gitCommitDiff']
  ...
  'host.lspCloseDocument': HostApi['lspCloseDocument']
  'host.lspHoverDocument': HostApi['lspHoverDocument']
  'host.terminalProfiles': HostApi['terminalProfiles']
  'host.terminalSpawn': HostApi['terminalSpawn']
  ...
  'host.browserList': HostApi['browserList']
  ...
  'host.browserReload': HostApi['browserReload']
  'host.browserSnapshot': HostApi['browserSnapshot']
  'host.browserClick': HostApi['browserClick']
  'host.browserType': HostApi['browserType']
  'host.browserScroll': HostApi['browserScroll']
  'host.browserSelectOption': HostApi['browserSelectOption']
  'host.browserResizeViewport': HostApi['browserResizeViewport']
  'host.browserSendPointer': HostApi['browserSendPointer']
  'host.browserSendKeyboard': HostApi['browserSendKeyboard']
