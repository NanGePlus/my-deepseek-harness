...
import {
  ...
  hostGitStageRequestSchema,
  hostGitUnstageRequestSchema,
  hostGitDiscardRequestSchema,
  hostGitCommitRequestSchema,
  hostGitPushRequestSchema,
  hostGitAddRemoteRequestSchema,
  hostGitRemoveRemoteRequestSchema,
  hostGitLogRequestSchema,
  hostGitCommitDiffRequestSchema,
  ...
  hostLspCloseDocumentRequestSchema,
  hostLspHoverDocumentRequestSchema,
  ...
  hostBrowserShowWindowRequestSchema,
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'host.gitPush': { schema: hostGitPushRequestSchema, invoke: (api, r, signal) => api.host.gitPush(r, signal) },
  'host.gitAddRemote': { schema: hostGitAddRemoteRequestSchema, invoke: (api, r, signal) => api.host.gitAddRemote(r, signal) },
  'host.gitRemoveRemote': { schema: hostGitRemoveRemoteRequestSchema, invoke: (api, r, signal) => api.host.gitRemoveRemote(r, signal) },
  'host.gitLog': { schema: hostGitLogRequestSchema, invoke: (api, r, signal) => api.host.gitLog(r, signal) },
  'host.gitCommitDiff': { schema: hostGitCommitDiffRequestSchema, invoke: (api, r, signal) => api.host.gitCommitDiff(r, signal) },
  ...
  'host.browserShowWindow': { schema: hostBrowserShowWindowRequestSchema, invoke: (api, r, signal) => api.host.browserShowWindow(r, signal) },
